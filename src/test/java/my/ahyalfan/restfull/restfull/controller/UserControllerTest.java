...
class UserControllerTest {
    ...
    void getUserSuccess() throws Exception {
        ...
        user.setName("Test");
        user.setToken("test");
        user.setTokenExpiration(System.currentTimeMillis() + 10000000000L);
        userRepository.save(user);
    ...
    void getUserTokenExpired() throws Exception {
        ...
        user.setName("Test");
        user.setToken("test");
        user.setTokenExpiration(System.currentTimeMillis() - 10000000);
        userRepository.save(user);
    ...
    void updateUserSuccess() throws Exception {
        ...
        user.setName("Test");
        user.setToken("test");
        user.setTokenExpiration(System.currentTimeMillis() + 100000000000L);
        userRepository.save(user);
